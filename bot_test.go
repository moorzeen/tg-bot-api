...
func TestSendWithMessage(t *testing.T) {
	...
	msg := NewMessage(ChatID, "A test message from the test library in tg-bot-api")
...
func TestPinChatMessage(t *testing.T) {
	...
	msg := NewMessage(SupergroupChatID, "A test message from the test library in tg-bot-api")
	msg.ParseMode = ModeMarkdown
	message, _ := bot.Send(msg)
